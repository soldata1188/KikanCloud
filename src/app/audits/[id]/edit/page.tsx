                    ...
                    <form action={updateAudit} className="space-y-6">
                        ...
                        <div className="bg-white border border-gray-300 rounded-xl p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div><label className="block text-sm font-medium text-[#1f1f1f] mb-2">予定日 <span className="text-red-500">*</span></label><input name="scheduled_date" type="date" required defaultValue={audit.scheduled_date} className="w-full bg-white focus:bg-white border border-gray-300 focus:border-[#1f1f1f] rounded-xl px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                <div><label className="block text-sm font-medium text-[#1f1f1f] mb-2">担当スタッフ</label><input name="pic_name" type="text" defaultValue={audit.pic_name || ''} className="w-full bg-white focus:bg-white border border-gray-300 focus:border-[#1f1f1f] rounded-xl px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
