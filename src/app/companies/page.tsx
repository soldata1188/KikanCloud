                ...
                <div className="flex-1 flex flex-col px-4 pb-12 w-full max-w-[1200px] mx-auto mt-4 md:mt-8">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2 pl-2">
                        ...
                        <div className="flex items-center gap-3 overflow-x-auto pb-2 md:pb-0">
                            ...
                            <Link href="/companies/bulk-input" className="flex items-center gap-2 px-6 py-3 bg-white hover:bg-gray-50 text-[#1f1f1f] rounded-[32px] text-sm font-medium transition-colors shadow-sm border border-[#e1e5ea] shrink-0">
                                <ListPlus size={18} strokeWidth={2} /> 一括入力
                            </Link>
                            <Link href="/companies/new" className="flex items-center gap-2 px-6 py-3 bg-white hover:bg-gray-50 text-[#1f1f1f] rounded-[32px] text-sm font-medium transition-colors shadow-sm border border-[#e1e5ea] shrink-0">
