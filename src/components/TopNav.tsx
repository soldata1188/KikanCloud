            ...
            <header className="h-14 bg-white border-b border-[#ededed] flex items-center justify-between px-4 sm:px-6 sticky top-0 z-40 shrink-0 w-full">
                <div className="flex items-center gap-2 text-[13px]">
                    <button
                        ...
                        className="w-6 h-6 flex items-center justify-center hover:scale-110 transition-transform cursor-pointer focus:outline-none"
                        title="About KikanCloud"
                    >
                        <Logo className="w-5 h-5 shrink-0" variant="color" />
                    </button>
