                ...
                <div className="flex-1 flex flex-col px-4 pb-12 w-full max-w-[800px] mx-auto mt-4 md:mt-8">
                    ...
                    <div className="bg-white rounded-[32px] shadow-[0_4px_16px_rgba(0,0,0,0.04)] border border-[#e1e5ea] p-8 md:p-10">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <span className="text-xs text-gray-400 bg-gray-100 px-3 py-1 rounded-full">編集中</span>
                        </div>
                        ...
                        <form action={updateWorker} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input name="full_name_romaji" type="text" required defaultValue={worker.full_name_romaji} className="w-full bg-[#f0f4f9] hover:bg-[#e1e5ea]/50 focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3.5 outline-none transition-all uppercase text-[#1f1f1f]" />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-[#444746] mb-2">氏名（カナ） <span className="text-red-500 ml-1">*</span></label>
                                    <input name="full_name_kana" type="text" required defaultValue={worker.full_name_kana} className="w-full bg-[#f0f4f9] hover:bg-[#e1e5ea]/50 focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3.5 outline-none transition-all text-[#1f1f1f]" />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input name="dob" type="date" required defaultValue={worker.dob} className="w-full bg-[#f0f4f9] hover:bg-[#e1e5ea]/50 focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3.5 outline-none transition-all text-[#1f1f1f]" />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-[#444746] mb-2">在留カード番号</label>
                                    <input name="zairyu_no" type="text" defaultValue={worker.zairyu_no || ''} maxLength={12} className="w-full bg-[#f0f4f9] hover:bg-[#e1e5ea]/50 focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3.5 outline-none transition-all uppercase text-[#1f1f1f]" />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2 border-t border-[#f0f4f9]">
                                <div>
                                    ...
                                    <select name="system_type" required defaultValue={worker.system_type} className="w-full bg-[#f0f4f9] hover:bg-[#e1e5ea]/50 focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3.5 outline-none transition-all appearance-none cursor-pointer text-[#1f1f1f]">
                                ...
                                <div>
                                    ...
                                    <select name="status" required defaultValue={worker.status} className="w-full bg-[#f0f4f9] hover:bg-[#e1e5ea]/50 focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3.5 outline-none transition-all appearance-none cursor-pointer text-[#1f1f1f]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="company_id" defaultValue={worker.company_id || ''} className="w-full bg-[#f0f4f9] hover:bg-[#e1e5ea]/50 focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3.5 outline-none transition-all appearance-none cursor-pointer text-[#1f1f1f]">
                                ...
                                <div>
                                    ...
                                    <input name="entry_date" type="date" defaultValue={worker.entry_date || ''} className="w-full bg-[#f0f4f9] hover:bg-[#e1e5ea]/50 focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3.5 outline-none transition-all text-[#1f1f1f]" />
                                </div>
                            </div>
