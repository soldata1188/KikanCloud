                    ...
                    <form action={updateWorker} className="space-y-6">
                        ...
                        <div className="bg-white rounded-md p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div><label className="block text-sm font-medium text-[#1f1f1f] mb-2">ステータス <span className="text-red-500">*</span></label><select name="status" required defaultValue={worker.status} className="w-full bg-[#fbfcfd] focus:bg-white -transparent focus: rounded-md px-4 py-3 outline-none appearance-none text-[#1f1f1f] transition-all"><option value="waiting">入国待ち</option><option value="standby">待機中</option><option value="working">就業中</option><option value="missing">失踪</option><option value="returned">帰国</option></select></div>
