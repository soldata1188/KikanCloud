            ...
            <div className="flex-1 flex flex-col relative min-w-0">
                ...
                <main className="flex-1 overflow-y-auto p-6 md:p-10">
                    <div className="max-w-[1200px] mx-auto">
                        ...
                        <div className="bg-white rounded-lg border border-gray-350 overflow-hidden mb-6">
                            <div className="flex border-b border-gray-350 bg-white">
                                <a href="?tab=profile" className={`flex items-center gap-2 px-6 py-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'profile' ? 'border-[#24b47e] text-[#24b47e] bg-white' : 'border-gray-350 text-[#878787] hover:text-[#1f1f1f] hover:bg-gray-50'}`}>
                                    <Building2 size={16} /> 基本情報 (Profile)
                                </a>
                                <a href="?tab=staff" className={`flex items-center gap-2 px-6 py-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'staff' ? 'border-[#24b47e] text-[#24b47e] bg-white' : 'border-gray-350 text-[#878787] hover:text-[#1f1f1f] hover:bg-gray-50'}`}>
