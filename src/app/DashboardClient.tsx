            ...
            <div className="flex flex-col">
                ...
                <section className="relative flex flex-col min-h-[500px] h-full -mx-6 md:mx-0 px-6 md:px-0 mb-8">
                    ...
                    <div className="pt-4 pb-2 shrink-0 relative z-10">
                        ...
                        <form onSubmit={handleChat} className="relative max-w-3xl lg:max-w-2xl mx-auto flex items-end gap-3 bg-transparent border-[0.5px] border-gray-300 focus-within:border-[#24b47e] focus-within:shadow-[0_0_0_1px_rgba(36,180,126,0.2)] rounded-[32px] p-2 md:p-2.5 transition-all duration-300">
                            <textarea
