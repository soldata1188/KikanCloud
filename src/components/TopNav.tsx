    ...
    return (
        <header className="h-12 bg-[#0067b8] text-white flex items-center justify-between px-4 shrink-0 z-[100] shadow-sm sticky top-0">
            <div className="flex items-center gap-4">
                ...
                <span className="font-semibold text-sm tracking-wide">Solution Cooperative</span>
            </div>
            ...
            <div className="flex items-center gap-6 text-[12px] font-medium relative z-10">
                ...
                <div className="relative group/avatar">
                    <div className="w-7 h-7 rounded-full bg-white/20 text-white flex items-center justify-center font-normal text-[11px] cursor-pointer shrink-0 border border-white/30 group-hover/avatar:scale-105 transition-all">
