                    ...
                    <form action={updateCompany} className="flex flex-col h-full relative">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 pl-2 sticky top-0 bg-[#f0f4f9] z-20 py-4 -mx-4 px-4 sm:mx-0 sm:px-0">
                            ...
                            <div className="flex items-center gap-3">
                                <Link href="/companies" className="px-6 py-3 text-[#444746] bg-white border border-[#e1e5ea] font-medium hover:bg-gray-50 rounded-[32px] transition-colors shadow-sm">キャンセル</Link>
                                <UpdateButton />
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-[32px] shadow-sm border border-[#e1e5ea] p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div><label className="block text-sm font-medium text-[#444746] mb-2">郵便番号</label><input name="postal_code" type="text" defaultValue={company.postal_code || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                    <div><label className="block text-sm font-medium text-[#444746] mb-2">電話番号</label><input name="phone" type="text" defaultValue={company.phone || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                    <div className="md:col-span-2"><label className="block text-sm font-medium text-[#444746] mb-2">所在地（住所）</label><input name="address" type="text" defaultValue={company.address || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[32px] shadow-sm border border-[#e1e5ea] p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="md:col-span-2"><label className="block text-sm font-medium text-[#444746] mb-2">代表者名</label><input name="representative" type="text" defaultValue={company.representative || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                    <div><label className="block text-sm font-medium text-[#444746] mb-2">責任者</label><input name="manager_name" type="text" defaultValue={company.manager_name || ''} placeholder="例：田中 健太" className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                    <div><label className="block text-sm font-medium text-[#444746] mb-2">連絡・実習担当者</label><input name="pic_name" type="text" defaultValue={company.pic_name || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                    <div><label className="block text-sm font-medium text-[#444746] mb-2">生活指導員</label><input name="life_advisor" type="text" defaultValue={company.life_advisor || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                    <div><label className="block text-sm font-medium text-[#444746] mb-2">技能指導員</label><input name="tech_advisor" type="text" defaultValue={company.tech_advisor || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                </div>
                            </div>
                        </div>
                    </form>
