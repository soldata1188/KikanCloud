...
export default async function AuditPrintPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | undefined }> }) {
 ...
 <table className="w-full border-collapse border-2 border-gray-350 text-[11px] leading-tight print-table">
 <thead>
 <tr className="bg-gray-100/80">
 <th className="border border-gray-350 border-t-2 border-b-2 border-gray-350 px-1 py-1.5 w-[4%] text-center font-bold tracking-tighter text-gray-800">No</th>
 <th className="border border-gray-350 border-t-2 border-b-2 border-gray-350 px-2 py-1.5 w-[22%] text-left font-bold tracking-tighter text-gray-800">受入企業名</th>
 <th className="border border-gray-350 border-t-2 border-b-2 border-gray-350 px-1.5 py-1.5 w-[13%] text-left font-bold tracking-tighter text-gray-800">在籍人数</th>
 <th className="border border-gray-350 border-t-2 border-b-2 border-gray-350 px-1.5 py-1.5 w-[10%] text-center font-bold tracking-tighter text-gray-800">種別</th>
 <th className="border border-gray-350 border-t-2 border-b-2 border-gray-350 px-1.5 py-1.5 w-[14%] text-center font-bold tracking-tighter text-gray-800">前回実績</th>
 <th className="border border-gray-350 border-t-2 border-b-2 border-gray-350 px-1.5 py-1.5 w-[13%] text-center font-bold tracking-tighter text-gray-800">実施日</th>
 <th className="border border-gray-350 border-t-2 border-b-2 border-gray-350 px-1.5 py-1.5 w-[9%] text-center font-bold tracking-tighter text-gray-800">担当</th>
 <th className="border border-gray-350 border-t-2 border-b-2 border-gray-350 px-2 py-1.5 w-[15%] text-left font-bold tracking-tighter text-gray-800">メモ</th>
 </tr>
 </thead>
 ...
 <td className="border border-gray-350 px-1 py-1.5 text-center align-top text-gray-600">{i + 1}</td>
 <td className="border border-gray-350 px-2 py-1.5 font-bold align-top leading-tight text-gray-900">{row.company.name_jp}</td>
 <td className="border border-gray-350 px-1.5 py-1.5 align-top text-[10px]">
 ...
 <td className="border border-gray-350 px-1.5 py-1.5 text-center align-top whitespace-nowrap tracking-tighter font-medium">{typeLabel}</td>
 <td className="border border-gray-350 px-1.5 py-1.5 text-center align-top text-[10px] whitespace-nowrap tracking-tighter text-gray-600 font-mono">{lastAuditStr}</td>
 <td className="border border-gray-350 px-1.5 py-1.5 text-center align-top text-[11px] font-bold whitespace-nowrap tracking-tighter text-gray-900">{dateStr}</td>
 <td className="border border-gray-350 px-1.5 py-1.5 text-center align-top whitespace-nowrap tracking-tighter text-gray-800">{audit?.pic_name || '-'}</td>
 <td className="border border-gray-350 px-2 py-1.5 text-[10px] text-gray-600 align-top leading-relaxed whitespace-pre-wrap break-all">{audit?.notes || '-'}</td>
 </tr>
 );
 })}
 </tbody>
