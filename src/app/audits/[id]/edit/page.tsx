                    ...
                    <form action={updateAudit} className="space-y-6">
                        ...
                        <div className="bg-white rounded-[32px] shadow-sm border border-[#e1e5ea] p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">担当スタッフ</label><input name="pic_name" type="text" defaultValue={audit.pic_name || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                        ...
                        <div className="pt-4 pb-8 flex justify-between items-center sticky bottom-4">
                            ...
                            <div className="flex gap-3"><Link href="/audits" className="px-6 py-3 text-[#444746] bg-white border border-[#e1e5ea] font-medium hover:bg-gray-50 rounded-[32px] transition-colors shadow-sm">キャンセル</Link><UpdateButton /></div>
                        </div>
                    </form>
                </div>
            </main>
