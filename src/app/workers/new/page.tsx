                        ...
                        <div className="bg-white rounded-md p-6 sm:p-8 border border-[#ededed] relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="nationality" required defaultValue="ベトナム" className="w-full bg-[#fbfcfd] border border-[#ededed] focus:bg-white focus:border-[#24b47e] focus:ring-[3px] focus:ring-[#24b47e]/10 rounded-md px-4 py-3 outline-none appearance-none text-[#1f1f1f] transition-all">
                        ...
                        <div className="bg-white rounded-md p-6 sm:p-8 border border-[#ededed] relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input name="zairyu_exp" type="date" className="w-full bg-[#fbfcfd] border border-[#ededed] focus:bg-white focus:border-[#24b47e] focus:ring-[3px] focus:ring-[#24b47e]/10 rounded-md px-4 py-3 outline-none text-[#1f1f1f] transition-all" />
                                </div>
                                <div>
                                    <label className="flex items-center gap-2 text-sm font-medium text-[#1f1f1f] mb-2">
                                        パスポート番号
                                    ...
                                    <input name="passport_no" type="text" placeholder="例：C1234567" className="w-full bg-[#fbfcfd] border border-[#ededed] focus:bg-white focus:border-[#24b47e] focus:ring-[3px] focus:ring-[#24b47e]/10 rounded-md px-4 py-3 outline-none uppercase text-[#1f1f1f] transition-all" />
                                </div>
                                <div>
                                    <label className="flex items-center gap-2 text-sm font-medium text-[#1f1f1f] mb-2">
                                        パスポート期限
