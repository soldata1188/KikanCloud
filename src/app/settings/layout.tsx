                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <aside className="w-full md:w-64 shrink-0">
                            <nav className="flex flex-col gap-2">
                                <Link href="/settings/profile" className="flex items-center gap-3 px-4 py-3 bg-white rounded-md text-[#1f1f1f] hover:bg-[#fbfcfd] font-medium transition-colors">
                                    <User size={20} className="text-[#24b47e]" />
                                    プロフィール設定
                                </Link>
                                <Link href="/settings/system" className="flex items-center gap-3 px-4 py-3 bg-white rounded-md text-[#1f1f1f] hover:bg-[#fbfcfd] font-medium transition-colors">
