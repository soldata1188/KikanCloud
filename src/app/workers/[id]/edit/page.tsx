                ...
                <div className="flex-1 flex flex-col px-4 pb-12 w-full max-w-[800px] mx-auto mt-4 md:mt-8">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pl-2">
                        ...
                        <div className="flex items-center gap-3">
                            <Link href={`/workers/${worker.id}/documents`} className="flex items-center gap-2 px-5 py-2.5 bg-blue-50 text-[#4285F4] hover:bg-blue-100 rounded-[32px] text-sm font-bold transition-colors border border-blue-100 shadow-sm">
                                <FolderOpen size={16} strokeWidth={2} /> 関連書類・ファイル管理
                            </Link>
                            <span className="text-xs text-gray-500 bg-gray-100 px-3 py-2 rounded-[32px] font-medium border border-gray-200">編集中</span>
                        </div>
                    </div>
                    ...
                    <form action={updateWorker} className="space-y-6">
                        ...
                        <div className="bg-white rounded-[32px] shadow-sm border border-[#e1e5ea] p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">入国日</label><input name="entry_date" type="date" defaultValue={worker.entry_date || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-[32px] shadow-sm border border-[#e1e5ea] p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">パスポート期限</label><input name="passport_exp" type="date" defaultValue={worker.passport_exp || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                ...
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">認定修了日</label><input name="cert_end_date" type="date" defaultValue={worker.cert_end_date || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">保険期限</label><input name="insurance_exp" type="date" defaultValue={worker.insurance_exp || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-[32px] px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                            </div>
                        </div>
