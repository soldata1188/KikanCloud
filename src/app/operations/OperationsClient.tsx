...
export default function OperationsClient({
    ...
    return (
        <div className="min-h-full flex flex-col relative anim-page">
            ...
            {/* ════ 一括操作 RIGHT SIDEBAR ════ */}
            <div className={`fixed top-[52px] right-0 h-[calc(100vh-52px)] z-[800] transition-transform duration-300 ease-in-out ${selectedIds.size > 0 ? 'translate-x-0' : 'translate-x-full'}`}
                style={{ width: '320px' }}>
