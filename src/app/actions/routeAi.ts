...
export async function optimizeRouteWithAI(locations: any[], startTime: string = '09:00') {
 ...
 ${context}
 Task:
 Logically order these locations to minimize driving time and zigzagging (solve the Traveling Salesperson Problem based on addresses). Include a 1-hour lunch break around 12:00 PM - 13:00 PM.
