...
export function ImportModal() {
 ...
 <div className="bg-white rounded-[32px] w-full max-w-[1000px] overflow-hidden flex flex-col max-h-[90vh]"> 
 ...
 <div className="rounded-[32px] overflow-hidden max-h-[350px] overflow-y-auto">
