    ...
    return (
        <div className="max-w-3xl">
            ...
            <div className="flex flex-col gap-8 text-[#1f1f1f]">
                {/* Visual Settings */}
                <div className="bg-[#f0f4f9] p-6 rounded-[24px]">
                    <h4 className="flex items-center gap-2 font-semibold mb-4 text-base">
                        <Palette className="text-[#4285F4]" size={20} /> 表示とテーマ
                    </h4>
                    <div className="flex flex-col gap-4 pl-7">
                        <div className="flex justify-between items-center">
                            <div>
                                <p className="font-medium">ダークモード (Dark Mode)</p>
                                <p className="text-sm text-gray-500">画面背景を暗くして目の疲れを軽減します。</p>
                            </div>
                        ...
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">影を消してモダンなKikanCloudデザインを適用します。</p>
                            </div>
                    ...
                    <div className="flex flex-col gap-4 pl-7">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">KikanCloud 全体の表示言語を選択します。</p>
                            </div>
                            <select className="px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-sm text-[#444746]" disabled>
                        ...
                        <div className="flex justify-between items-center mt-2">
                            ...
                            <span className="text-sm text-gray-400 bg-white px-3 py-1.5 rounded-lg border border-gray-100">Asia/Tokyo</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col gap-4 pl-7">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">監査期限や在留カード更新の警告メールを受け取ります。</p>
                            </div>
                            <input type="checkbox" className="toggle-switch w-10 h-5" defaultChecked disabled />
                        </div>
                    </div>
