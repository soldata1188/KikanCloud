...
export default async function NewAuditPage() {
 ...
 <div><label className="block text-sm font-medium text-[#1f1f1f] mb-2">予定日 <span className="text-red-500">*</span></label><input name="scheduled_date"type="date"required className="w-full bg-white focus:bg-white border border-gray-350 focus:border-[#1f1f1f] rounded-md px-4 py-3 outline-none text-[#1f1f1f] transition-all"/></div>
 <div><label className="block text-sm font-medium text-[#1f1f1f] mb-2">担当スタッフ</label><input name="pic_name"type="text"defaultValue={userProfile?.full_name || ''} className="w-full bg-white focus:bg-white border border-gray-350 focus:border-[#1f1f1f] rounded-md px-4 py-3 outline-none text-[#1f1f1f] transition-all"/></div>
