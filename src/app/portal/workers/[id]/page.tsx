        ...
        <div className="flex h-screen bg-[#f4f7f6] font-sans text-[#1f1f1f] overflow-hidden">
            ...
            <main className="flex-1 flex flex-col relative overflow-y-auto no-scrollbar px-4 pb-12 w-full max-w-[1000px] mx-auto mt-4 md:mt-8">
                <div className="flex items-center gap-4 mb-8">
                    <Link href="/portal/workers" className="w-10 h-10 flex items-center justify-center rounded-full bg-white shadow-sm hover:bg-gray-50 text-[#444746]"><ArrowLeft size={20} /></Link>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-[32px] p-6 shadow-sm border border-gray-100 flex flex-col items-center text-center">
                            <div className="w-24 h-24 rounded-full bg-teal-50 flex items-center justify-center border-4 border-teal-100 overflow-hidden mb-4">
                            ...
                            <div className="w-full mt-6 space-y-3 text-left bg-gray-50 p-4 rounded-2xl">
                    ...
                    <div className="lg:col-span-2">
                        <div className="mb-4 bg-teal-50 border border-teal-100 rounded-2xl p-4 text-sm text-teal-800 font-medium">
