...
CRITICAL RULE: Return ONLY a raw JSON object. Do NOT include markdown code blocks. Output values in Japanese where applicable.
`;
        ...
        const msg = error instanceof Error ? error.message : '画像のデータ抽出に失敗いたしました。恐れ入りますが、再度お試しください。';
