                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <aside className="w-full md:w-64 shrink-0">
                            <nav className="flex flex-col gap-2">
                                <Link href="/settings/profile" className="flex items-center gap-3 px-4 py-3 bg-white rounded-[32px] text-[#444746] hover:bg-gray-50 font-medium transition-colors">
                                    <User size={20} className="text-[#4285F4]" />
                                    プロフィール設定
                                </Link>
                                <Link href="/settings/system" className="flex items-center gap-3 px-4 py-3 bg-white rounded-[32px] text-[#444746] hover:bg-gray-50 font-medium transition-colors">
                        ...
                        <div className="flex-1 bg-white rounded-[32px] p-8 min-h-[500px]">
                            {children}
                        </div>
                    </div>
                </div>
