...
export default async function EditCompanyPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <div><label className="block text-sm font-medium text-[#1f1f1f] mb-2">連絡・実習担当者</label><input name="pic_name" type="text" defaultValue={company.pic_name || ''} className="w-full bg-[#fbfcfd] focus:bg-white -transparent focus: rounded-md px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div> 
