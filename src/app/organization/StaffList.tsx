...
export default function StaffList({ initialStaff, organizationId }: { initialStaff: any[], organizationId: string }) {
 ...
 {isAddMode && (
 <div className="bg-white border border-gray-350 rounded-lg p-6 mb-8">
 ...
 <input name="fullName"required className="w-full text-sm border border-gray-350 rounded px-3 py-2 outline-none focus:border-[#878787]"/>
 </div>
 <div>
 <label className="block text-xs font-medium text-[#878787] mb-1">ログイン Email</label>
 <input name="email"type="email"required className="w-full text-sm border border-gray-350 rounded px-3 py-2 outline-none focus:border-[#878787]"/>
 </div>
 <div>
 <label className="block text-xs font-medium text-[#878787] mb-1">仮パスワード (Min 6 chars)</label>
 <input name="password"type="password"required minLength={6} className="w-full text-sm border border-gray-350 rounded px-3 py-2 outline-none focus:border-[#878787]"/>
 </div>
 <div>
 <label className="block text-xs font-medium text-[#878787] mb-1">権限 (Role)</label>
 <select name="role"className="w-full text-sm border border-gray-350 rounded px-3 py-2 outline-none focus:border-[#878787]">
