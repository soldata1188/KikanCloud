    ...
    return (
        <div className="flex-1 flex flex-col w-full max-w-[1200px] mx-auto mt-4 md:mt-8">
            <div className="bg-white rounded-md p-4 mb-6 space-y-4">
                <div className="min-h-[48px] px-4 py-2 flex items-center gap-3 bg-white rounded-md -transparent focus-within:bg-white focus-within: transition-colors">
                ...
                <div className="flex flex-wrap items-center gap-3 px-1">
                    ...
                    <select
                        ...
                        className="bg-white text-[#1f1f1f] text-sm rounded-md px-4 py-2 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#4285F4]/20 transition-all font-medium appearance-none min-w-[140px] cursor-pointer"
                    >
                    ...
                    <select
                        ...
                        className="bg-white text-[#1f1f1f] text-sm rounded-md px-4 py-2 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#4285F4]/20 transition-all font-medium appearance-none min-w-[160px] cursor-pointer"
                    >
                                    ...
                                    <tr key={w.id} className="hover:bg-white transition-colors group">
                                        ...
                                        <td className="px-4 py-2">
                                            <div className="flex items-center gap-3.5">
                                                <div className="w-11 h-11 rounded-md bg-white overflow-hidden flex items-center justify-center shrink-0">
                                        ...
                                        <td className="px-4 py-2">
                                            <div className="flex flex-col items-start gap-2">
                                                <span className={`px-2.5 py-1 rounded-md text-[11px] font-bold border ${w.system_type === 'ikusei_shuro' ? 'bg-emerald-50 text-emerald-700 border-emerald-100/50' : w.system_type === 'tokuteigino' ? 'bg-white text-blue-700 border-blue-100/50' : 'bg-red-50 text-red-700 border-red-100/50'}`}>
