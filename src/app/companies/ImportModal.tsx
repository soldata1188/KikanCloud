...
export function ImportModal() {
    ...
    const downloadTemplate = () => {
        const headers = ['企業名（日本語）', '企業名（ローマ字）', '法人番号（13桁）', '郵便番号', '所在地（住所）', '電話番号', '代表者名', '連絡・実習担当者', '生活・技能指導員']
        const csvContent = "data:text/csv;charset=utf-8,\uFEFF" + headers.join(',') + '\n株式会社サンプル,SAMPLE CO.,1234567890123,100-0001,東京都千代田区,03-1234-5678,山田 太郎,鈴木 一郎,佐藤 花子'
                        ...
                        <div className="p-8 overflow-y-auto">
                            {!parsedData.length ? (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="border border-[#e1e5ea] rounded-2xl overflow-hidden max-h-[300px] overflow-y-auto">
