        ...
        <div className="flex h-screen bg-white font-sans text-[#1f1f1f] overflow-hidden">
            ...
            <main className="flex-1 flex flex-col relative overflow-y-auto no-scrollbar px-4 pb-12 w-full max-w-[800px] mx-auto mt-4 md:mt-8">
                ...
                {userProfile.role === 'company_admin' ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-[#878787] bg-white/50 rounded-lg m-4 border border-gray-200"><p className="font-bold text-[#1f1f1f] text-base">閲覧専用アカウントです</p><p className="text-sm mt-1">メッセージの送信権限がありません。</p></div>
                )}
            </main>
        </div>
    )
