                ...
                <div className="flex-1 flex flex-col px-4 pb-12 w-full max-w-[800px] mx-auto mt-4 md:mt-8">
                    ...
                    <form action={updateCompany} className="space-y-6">
                        ...
                        <div className="bg-white rounded-[32px] shadow-sm border border-[#e1e5ea] p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">郵便番号</label><input name="postal_code" type="text" defaultValue={company.postal_code || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">電話番号</label><input name="phone" type="text" defaultValue={company.phone || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                        ...
                        <div className="bg-white rounded-[32px] shadow-sm border border-[#e1e5ea] p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">連絡・実習担当者</label><input name="pic_name" type="text" defaultValue={company.pic_name || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                                <div><label className="block text-sm font-medium text-[#444746] mb-2">生活・技能指導員</label><input name="guidance_manager" type="text" defaultValue={company.guidance_manager || ''} className="w-full bg-[#f0f4f9] focus:bg-white border border-transparent focus:border-[#4285F4] rounded-2xl px-4 py-3 outline-none text-[#1f1f1f] transition-all" /></div>
                            </div>
                        </div>
