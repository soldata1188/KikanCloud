                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-md p-6 flex flex-col items-center text-center">
                            <div className="w-24 h-24 rounded-md bg-white flex items-center justify-center border border-gray-200 overflow-hidden mb-4">
                    ...
                    <div className="lg:col-span-2">
                        <div className="mb-4 bg-white border border-teal-100 rounded-md p-4 text-sm text-teal-800 font-medium">
